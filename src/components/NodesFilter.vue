<template>
    <div class="map_filters">
        ...
        <div :class="['map_filter ico_electrical_items', {filter_active: filter.electrical_items}]" @click="filter.invert('electrical_items')">
